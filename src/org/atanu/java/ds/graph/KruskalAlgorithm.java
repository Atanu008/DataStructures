...
public class KruskalAlgorithm {
    ...
    public void minimumSpanningTree(int[][] edges, int n){
        ...
        // Technically don't need to check for n-1 edges
        // once all the nodes are connected via union in a single component , no more edges will be connected
        for(int[] edge : edges){
            ...
            // If u and v does not form a cycle connect them
            // If already connected union will return true
            // If not connected union will return false
